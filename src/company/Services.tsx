            ...
            <div>
                ...
                <main className='pt-[72px]'>
                    <section className="w-full pb-28 xl:w-[79%] mx-auto min-h-96 py-[100px] px-7 xl:px-0 ">
                        <h1 className="text-[57px] font-semibold">Services</h1>
                        <div className="text-[16px] font-medium flex gap-2 items-center"><span>Home</span> <ChevronRight className='w-5 h-5' /> <span>Services</span></div>
